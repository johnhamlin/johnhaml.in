  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      >
        ...
        <div className="absolute right-[11rem] top-[-6rem] -z-10 h-[31.25rem] w-[31.25rem] rounded-full bg-[#fbe2e3] blur-[10rem] dark:bg-[#946263] sm:w-[68.75rem] transform-gpu will-change-transform"></div>
