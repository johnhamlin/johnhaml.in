...
I build tools that make people's lives easier, most recently at **xkite**, where we created open-source tools that make life easier for **Apache Kafka** devs. xkite lets you spin up containerized Kafka clusters in minutes, run custom tests, and export your setup for deployment
