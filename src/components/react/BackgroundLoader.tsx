...
export default function BackgroundLoader() {
  ...
  useEffect(() => {
    ...
    const checkPerformance = () => {
      ...
      setUseFallback(
        prefersReducedMotion || (isLowEndDevice && window.innerWidth < 768)
      );
  ...
  return (
    <div
      className="pointer-events-none fixed inset-0 -z-10 animate-fade-in overflow-hidden opacity-0 transition-opacity duration-300"
      aria-hidden="true"
